...
const cacheName = 'Fixit8RoshanRaj-2020-10-04 23:25:50.349333'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit8RoshanRaj'.length) === 'Fixit8RoshanRaj') {
